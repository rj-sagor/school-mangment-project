...
<table id="example" class="table table-striped table-bordered" style="width:100%">
 ...
 <tbody>
  ...
  @foreach ($fee_amount as $amount)
  <tr>
    <td>{{ $loop->index +1 }}</td>

    <td>{{ $amount->amountRletionFeeCate->fee_name }}</td>
    <td>
      <a class="btn btn-black" href="{{ route('Student.fee_amount.show',$amount->fee_category_id) }}"><i class="fa fa-eye"></i></a>
    </td>
  </tr>
  @endforeach
