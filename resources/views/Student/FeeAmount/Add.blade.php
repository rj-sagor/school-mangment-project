        ...
        <div class="add_item">
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Add Fee_category_amount <a href="{{ route('Student.fee_amount.index') }}" class="btn btn-sm btn-success">all Fee_category_amount</a></h2>
                        ...
                        <div class="x_content">
                            <br>
                            <form action="{{ route('Student.fee_amount.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
