        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br>
                        <form action="{{ route('Student.exam.update',$Exams->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method("PUT")
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text"  name="exam_name"  class="form-control " value="{{ $Exams->exam_name }}">
                                    @error('exam_name')
