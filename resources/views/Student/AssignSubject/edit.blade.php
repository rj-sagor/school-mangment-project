         ...
         @endif
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Edit Assign subject <a href="{{ route('Student.Assign_subject.index') }}" class="btn btn-sm btn-success">all Assign subject List</a></h2>
                        ...
                        <div class="x_content">
                            <br>
                            <form action="{{ route('Student.Assign_subject.update',$assign_sub->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method("PUT")
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4 col-sm-9 ">
                                       ...
                                       <option value="{{ $class->id }}" {{ $class->id == $assign_sub->class_id ? 'selected' : "" }}>{{ $class->class_name }}</option>
                                      @endforeach
                                        </select>
                                        @error('class_id')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2 col-sm-9 ">
                                       ...
                                       <option value="{{ $subject->id }}"{{ $subject->id == $assign_sub->subject_id ? 'selected': '' }}>{{ $subject->sub_name }}</option>
                                    ...
                                    <div class="col-md-2 col-sm-6 ">
                                        <input type="number"  name="full_mark"  class="form-control " value="{{ $assign_sub->full_mark }}">
                                        @error('full_mark')
                                        <p class="text text-danger">{{ $message }}</p>
                                    @enderror
                                    </div>
                                    ...
                                    <div class="col-md-2 col-sm-6 ">
                                        <input type="number"  name="pass_mark"  class="form-control "  value="{{ $assign_sub->pass_mark }}">
                                        @error('pass_mark')
                                        <p class="text text-danger">{{ $message }}</p>
                                    @enderror
                                    </div>
                                ...
                                <div class="col-md-2 col-sm-6 ">
                                    <input type="number"  name="subjective_mark"  class="form-control "  value="{{ $assign_sub->subjective_mark }}">
